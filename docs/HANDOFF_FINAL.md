...
- **코인 신호 백테스트(06-08, 사용자 요청)**: XRP 25/8·26/5·25/6·25/7 + ETH 25/4·25/7 재현(일봉, 미래누출X). 결론: A=랠리초입 2/3 적중(XRP 7/9 +48%·ETH 7/2 +48%·XRP 8/7 -5%컷), E=대바닥 1/1(ETH 4/9 발동→+115%), 🔻하락전환 경고 2/2, 바닥다지기 구간 오탐 0, 과열라벨≠매도신호 재확인. 텔레그램 보고 발송됨.
