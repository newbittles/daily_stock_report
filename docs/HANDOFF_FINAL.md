...
- 미국 리포트 스케줄: 장전 19:00+21:50(2차) / 장중 23:50 / 마감 06:30(게이트)+07:00(안전망), 전부 ABCD 3개.
...
- **origin/main 최신 커밋**: `a508ebd`(전략스크린 중복제거+_strats버그수정) + 서버 자동리포트 커밋. 2026-06-05 세션 전부 배포 완료.
